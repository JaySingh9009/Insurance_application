...
export function Policies() {
  ...
  const cancelPolicy = async (policyId) => {
    ...
    try {
      ...
      alert(e.response?.data?.message || "Failed to cancel policy.");
    }
  };
  ...
  const handleExport = () => {
    exportToCSV("Policies_List", filtered, {
    ...
    <AppLayout>
      <div className="topbar">
        <div className="topbar-left">
          ...
          <p className="topbar-greeting">Manage and inspect system policies</p>
        </div>
      ...
      <div className="page-container">
        ...
        >
          <select
            ...
            style={{ padding: "8px 12px", borderRadius: 8, border: "0.5px solid #e5e7eb", fontSize: 13 }}
          >
                        ...
                        <tr key={p.policyId}>
                          ...
                          <td>
                            <div className="action-row">
                              ...
                              {p.status === "ACTIVE" && (
                                <button className="btn-danger" onClick={() => cancelPolicy(p.policyId)}>
                                  Cancel
                                </button>
                              )}
                            </div>
