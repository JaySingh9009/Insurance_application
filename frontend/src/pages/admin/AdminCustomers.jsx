    ...
    <AppLayout>
      <header className="topbar">
        <div className="topbar-left">
          <h1 className="topbar-title">Customer Management</h1>
          <p className="topbar-greeting">Browse and inspect customer accounts and profiles</p>
        </div>
      ...
      <div className="page-container">
        {/* Inline Customer Profile Detail Card */}
        {selected && (
            ...
            <div className="card-header" style={{ padding: "16px 20px 12px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span className="card-title" style={{ fontSize: 16, fontWeight: 700 }}>
                  Customer Profile — {selected.fullName}
                </span>
              </div>
              <Button
                variant="ghost"
        ...
        <div className="card">
          <div className="card-header">
            <span className="card-title">Customers List</span>
            <span className="count-badge">
              {filtered.length} visible ({data.totalRecords || data.records?.length || 0} total)
            </span>
          </div>
                        ...
                        <tr key={c.customerId || c.id}>
                          ...
                          <td>
                            <button
                              className="btn-ghost"
                              onClick={() =>
                                setSelected(selected?.customerId === c.customerId ? null : c)
                              }
                            >
